function [d_coeff] = modified_geometry()

    [diffusion_coefficient, distance, sigma_abs, sigma_fission] = get_diff_coeff();
    d_coeff = [];
    global deltax;
    global len;
    global sigma_a
...
function [diffusion_coefficient, distance, sigma_abs, sigma_fission] = get_diff_coeff()
    global datafile
    load(datafile)
    distance = [];
